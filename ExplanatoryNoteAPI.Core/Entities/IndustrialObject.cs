...
namespace ExplanatoryNoteAPI.Core.Entities
{
	...
	/// </summary>
	public class IndustrialObject : BaseEntity
	{
		...
		[XmlElement("RawResources")]
		public Resources? RawResources { get; set; }

		[XmlIgnore]
		[ForeignKey(nameof(RawResources))]
		public Guid? RawResourcesId { get; set; }
		...
		[XmlElement("NuclearPlantFeatures")]
		public NuclearPlantFeatures? NuclearPlantFeatures { get; set; }

		[XmlIgnore]
		[ForeignKey(nameof(NuclearPlantFeatures))]
		public Guid? NuclearPlantFeaturesId { get; set; }
